    ...
    <section className={style.heroContainer}>
      <h1 className="heroHeader">
        ...
        <p className={style.heroAbout}>
          ...
          <span>I dont identify myself with a technology, I use the best one for the job. JavaScript, TypeScript, Python, C#.{" "}<a href="google.com" target="_blank">get my resume </a></span>
        </p>
      </h1>
